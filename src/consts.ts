...
const SCENE_INDEX_FAIL_SCREEN = 6
const SCENE_INDEX_SUCCESS_SCREEN = 7
const SCENE_INDEX_SLEEPING_DOG = 8
const SCENE_INDEX_FINISHED_SCREEN = 9


const PLAYER_STREET_START_X = 50
const PLAYER_STREET_START_Y = 900

const LEVEL_COUNT_TOTAL = 4
